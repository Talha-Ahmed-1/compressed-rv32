...
#endif
#include <iostream>
class InstAligner_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    InstAligner_api_t(VInstAligner* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
...
static InstAligner_api_t * _Top_api;
...
int main(int argc, char **argv, char **env) {
    ...
    VInstAligner* top = new VInstAligner;
    std::string vcdfile = "test_run_dir/Instruction_Aligner_Test/InstAligner.vcd";
    ...
    Verilated::mkdir("test_run_dir/Instruction_Aligner_Test/logs");
    VerilatedCov::write("test_run_dir/Instruction_Aligner_Test/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
